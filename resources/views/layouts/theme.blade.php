...
<html lang="en">
  ...
  <head>
    ...
    <link href="{{ asset('css/fonts/fontawesome-free/css/all.min.css') }}" rel="stylesheet">
    <link href="{{ asset('css/themes/sb-admin.min.css') }}" rel="stylesheet">
      ...
      <ul class="navbar-nav ml-auto ml-md-0">
        ...
        <li class="nav-item dropdown no-arrow">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
            <a class="dropdown-item" href="{{ url('/web/company') }}">Dados da empresa</a>
            <a class="dropdown-item" href="#">Activity Log</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="javascript:void(0);"
               onclick="app.login.logout()"
               title="Sair do sistema" id="logout"
               >Sair</a>
          </div>
        </li>
      </ul>
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright © Locadora 2018</span>
            </div>
          </div>
        </footer>
